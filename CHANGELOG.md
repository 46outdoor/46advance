...
- **Schedule lineup slots:** in the schedule's **Show** items you now pick a **stage + lineup slot** (Headliner, Direct Support, Artist 3…) instead of pinning one specific act; the item **auto-fills with whoever holds that slot** on that stage, showing "Headliner — unassigned" until an artist is assigned to it.
