...
- **The contacts directory and artist document library are becoming cross-event surfaces.**
  ...
  the event itself, so everyone on a show can still see and reach their own crew, and
  documents an editor included on an advance still open for every member. What goes away is
