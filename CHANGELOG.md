...
- **Contacts directory performance:** the contacts list is now **virtualized** (only visible rows render) inside a scrollable panel, so large directories (up to the 1,000-contact cap) stay smooth to scroll and search.
