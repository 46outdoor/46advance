...
| Auth custom claims / RBAC roles | `pwa/src/features/auth/lib/roles.ts` (roles + Zod), `permissions.ts` (predicates), claims setters in `functions/` | Any app's permission checks |
