...
- **[ACCESS_SCOPING_PLAN.md](ACCESS_SCOPING_PLAN.md)** — *complete 2026-09-03, ready to
  archive*. Narrowed the two globally-readable collections (contacts directory, artist document
  library) to the global capabilities, with crew reaching their own show's people through
  denormalized roster fields. Graduated from IDEAS §5; live on every target the same day.
